...
# buttons
buttonClear = Button(buttonFrame, text='C', fg='black', width=32, height=3, bd=0, bg='#eee', cursor='hand2', command= lambda: buttonClear()).grid(row=0, column=0, padx=1, pady=1, columnspan=3)
